...
<p class="stTxt">💰 В фонде <b>{Math.floor(g.funds)} ₽</b>. Отряду никто не платит: деньги приносят
  пожертвования за проделанную работу — прочёсанные квадраты и разобранные находки повышают отклик
  📣, а по итогам дела отряд публикует отчёт. Остаток фонда переходит в следующее дело.</p>
